...
- `docs/observability/MODEL-ROUTING-DASHBOARD-TEMPLATE.md`: model routing dashboard/report template for provider health, fallback, and latency tracking.
...
- `output/reports/observability/`: routing observability dashboards generated by `pnpm report:model-routing`.
