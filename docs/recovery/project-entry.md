...
> **Current recovery note (2026-04-13/14):** current requested target root is `/Volumes/AI_DEV_2T/01-projects/active/openclaw-workspace/projects/002-draftorbit.io`; implementation worktree is `/Users/yangshu/.config/superpowers/worktrees/002-draftorbit.io/recover-draftorbit-final`. Older paths in evidence bullets are historical.
...
3. `docs/v3-ux-flow.md`
   作用：当前主页面壳、迁移规则和用户流程。
4. `docs/recovery/knowledge-recovery-2026-04-08.md`
   作用：完整项目记忆恢复档案。
...
- 完整恢复包：`docs/recovery/knowledge-recovery-2026-04-08.md`
- 路径与索引收口清单：`docs/recovery/path-index-reconciliation-checklist-2026-04-08.md`
