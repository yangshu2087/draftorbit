...
function CallbackInner() {
  ...
  useEffect(() => {
    ...
    if (!state || !code) {
      ...
      const t = setTimeout(() => router.replace('/app?nextAction=connect_x_self&xbind=error'), 2200);
    ...
    (async () => {
      try {
        ...
        setTimeout(() => router.replace('/app?nextAction=connect_x_self&xbind=error'), 2500);
      }
    })();
